...
$(document).on('click', ".phone-keypad-key-call", function(e) {
    ...
    var InputNum = document.getElementById('phone-keypad-input').value
...
$(document).on('click', '.phone-keypad-key', function(e) {
    ...
    //console.log(document.getElementById('phone-keypad-input').value)

    if (!isNaN(PressedButton)) {
        //var keyPadHTML = $("#phone-keypad-input").text();
        //$("#phone-keypad-input").text(keyPadHTML + PressedButton)
        var keyPadHTML = document.getElementById('phone-keypad-input').value
        document.getElementById('phone-keypad-input').value = keyPadHTML + PressedButton
        ...
        if (ClearNumberTimer == null) {
            ...
            document.getElementById('phone-keypad-input').value = "Cleared"
            ClearNumberTimer = setTimeout(function() {
                $("#phone-keypad-input").text("");
                document.getElementById('phone-keypad-input').value = ""
        ...
        if (cData.number !== QB.Phone.Data.PlayerData.charinfo.phone) {
            if (status.IsOnline) {
                if (status.CanCall) {
                    ...
                    QB.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is in conversation!");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is not reachable!");
            }
        } else {
            QB.Phone.Notifications.Add("fas fa-phone", "Phone", "You can not call your own number!");
        }
    });
}
    ...
    if (!Canceled) {
        if (!QB.Phone.Data.CallActive) {
            ...
            setTimeout(function() {
                ...
                if (AnonymousCall) {
                    Label = "You are called by an anonymous number"
                }
