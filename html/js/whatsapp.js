...
$(document).on('click', '.whatsapp-chat', function(e) {
    ...
    if (OpenedChatPicture == null) {
        OpenedChatPicture = "./img/default.webp";
...
$(document).on('click', '#whatsapp-openedchat-delete', function(e) {
    e.preventDefault();
    //console.log(OpenedChatData.number)
    $.post('https://qb-phone/DeleteWhatsappMessage', JSON.stringify({
...
QB.Phone.Functions.LoadWhatsappChats = function(chats) {
    ...
    $.each(chats, function(i, chat) {
        var profilepicture = "./img/default.webp";
...
FormatMessageTime = function() {
    ...
    var NewSeconds = NewDate.getUTCSeconds();
    ...
    var MessageTime = Hourssssss + ":" + Minutessss + ":" + NewSeconds
    return MessageTime;
}
...
$(document).on('click', '#whatsapp-openedchat-send', function(e) {
    ...
    if (Message !== null && Message !== undefined && Message !== "") {
        ...
        QB.Phone.Notifications.Add("fab fa-whatsapp", "Whatsapp", "You cannot send an empty message!", "#25D366", 1750);
    }
});
...
QB.Phone.Functions.SetupChatMessages = function(cData, NewChatData) {
    if (cData) {
        ...
        $.each(cData.messages, function(i, chat) { //chat.time : "03:47:23", string    ; chat.date : "13-6-2022", string
