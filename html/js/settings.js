QB.Phone.Settings = {};
QB.Phone.Settings.Background = "stars";
...
QB.Phone.Functions.LoadMetaData = function(MetaData) {
    ...
    if (MetaData.profilepicture == "default") {
        $("[data-settingstab='profilepicture']").find('.settings-tab-icon').html('<img src="./img/default.webp">');
    } else {
...
$(document).on('click', '#accept-profilepicture', function(e) {
    ...
    if (ProfilePicture === "default") {
        QB.Phone.Notifications.Add("fas fa-paint-brush", "Settings", "Default profile photo is set!")
        QB.Phone.Animations.TopSlideUp(".settings-" + QB.Phone.Settings.OpenedTab + "-tab", 200, -100);
        $("[data-settingstab='profilepicture']").find('.settings-tab-icon').html('<img src="./img/default.webp">');
    } else {
        QB.Phone.Notifications.Add("fas fa-paint-brush", "Settings", "Custom profile photo set!")
        QB.Phone.Animations.TopSlideUp(".settings-" + QB.Phone.Settings.OpenedTab + "-tab", 200, -100);
